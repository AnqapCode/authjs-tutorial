  ...
  return (
    ...
    <form action={formAction} className="space-y-6">
      ...
      <div>
        ...
        <input type="email" name="email" placeholder="john.doe@gmail.com" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5" />
      ...
      <p className="text-sm font-light text-gray-500">
        ...
        <Link href="/register">
          <span className="font-medium pl-1 text-blue-600 hover:text-blue-700">Sign Up</span>
        </Link>
      </p>
    </form>
  );
